...
const Multiselect = ({selectedItems,addItem,setFilteredItems}) => {
        ...
        <div className="w-full flex flex-col items-center mx-auto">
          <div className="w-full">
            <div className="flex flex-col items-center relative">
              <div className="w-full ">
                <div className="my-2 p-1 flex border border-gray-600 bg-white rounded-lg">
            ...
            {dropdown ? (
              <Dropdown list={items} addItem={addTag} selectedItems={selectedItems}></Dropdown>
            ) : null}
          </div>
        </div>
      </div>
