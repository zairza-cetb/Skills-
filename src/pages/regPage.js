        ...
        <div className="page">
            <div className="regPage">
                ...
                <div className="layer1">
                    <p>Name</p>
                    <input type="name" placeholder="Enter your Name" className="name" name="name" value={user.name} onChange={changeHandler} />
                </div>
                <div className="layer2">
                    <p>Phone Number</p>
                    <div className="phoneInput">
                        <div><input type="name" placeholder="+91" className="phoneCode" /></div>
                        <div className="pc"><input type="name" placeholder="Phone Number" className="phoneNumber" onChange={checkPhnNo} /></div>
                    </div>
                </div>
                <div className="layer3">
                    ...
                    <div className="email2 e2">
                        ...
                        <input type="email" className="enterEmail" placeholder="Confirm your Email" name="confirmEmail" value={user.confirmEmail} onChange={changeHandler}/>
                    </div>
                </div>
                <div className="layer4">
                    ...
                    <div className="password p2">
                        ...
                        <div className="wrapfield">
                            <div><input type={showConfirmPassword ? "text" : "password"} className="enterPassword" placeholder="Confirm password" name="confirmPassword" value={user.confirmPassword} onChange={changeHandler}/></div>
                            <div className="shBtn"><button className="showbtn" onClick={confirmButtonHandler}>{showConfirmPassword ? <VisibilityOffIcon /> : <VisibilityIcon />}</button></div>
                        </div>
                    </div>
                </div>
                <div className="layer5">
                    <div className="student selectBranch">
                        <p>Branch</p>
                        <select className="branch option" name="selectBranch" value={user.selectBranch}>
                    ...
                    <div className="student r1">
                        <p>Regd No.</p>
                        <input type="text" className="regdNo" placeholder="Enter your redg no." name="enterRedgNo" value={user.enterRedgNo} onChange={changeHandler} />
                    </div>
                </div>
                <div className="layer6">
                    <div className="membership selectMember">
                        <p>Are you a Zairza Member?</p>
                        <select className="member option" onChange={ansHandle} name="selectOption" value={user.selectOption}>
                        ...
                        <input type="text" className="wing" placeholder="Enter your wing: eg:SOFTWARE" disabled={answer==="no"?true:false} name="enterWing" value={user.enterWing} onChange={changeHandler}/>
                    </div>
                </div>
                <div className="layer7 selectdomain">
                    <p>Interested Domain for Skills++ 2022</p>
                    <select className="domain option" name="selectDomain" value={user.selectDomain}>
                ...
                <div className="layer9">
                    <p>Already registered?<span onClick={() => nav("/login")}>Login</span></p>
                </div>
            </div>
            <div className="image">
